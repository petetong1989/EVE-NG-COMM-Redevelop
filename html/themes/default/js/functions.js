...
function printPageLabOpen(lab) {
    ...
    $.when(printLabTopology(), getPictures()).done(function(rc, pic) {
        ...
        $('#ab-sidebar ul').append('<li class="action-configs-li"><a class="action-configs-li" href="javascript:void(0)" title="' + MESSAGES[269] + '"><i class="glyphicon glyphicon-hdd"></i></a></li>');
